# Generated by Powerlevel10k configuration wizard on 2025-03-24 at 03:57 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # user@hostname (shows container name)
  ...
  # Always show context to display container name via hostname
  # typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=

  # Custom icon for container context
  typeset -g POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_EXPANSION='🐳'
  # Custom prefix for container 
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='in '
